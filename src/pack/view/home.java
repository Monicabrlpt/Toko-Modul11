...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(300, 20, 380, 60);

        jLabel2.setFont(new java.awt.Font("Quixley LET", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Admin Toko");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 20, 90, 30);

        txtadmin.setFont(new java.awt.Font("Quixley LET", 0, 18)); // NOI18N
        ...
        Btn_Keluar.setBackground(new java.awt.Color(0, 102, 0));
        ...
        jPanel2.setBounds(0, 90, 260, 400);
        ...
        Btn_Hapus.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        ...
        Btn_Simpan.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        ...
        Btn_Simpan.setBounds(90, 20, 110, 30);

        Btn_Ubah.setBackground(new java.awt.Color(0, 102, 0));
        Btn_Ubah.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        ...
        Btn_Ubah.setBounds(240, 20, 110, 30);

        Btn_Bersih.setBackground(new java.awt.Color(0, 102, 0));
        Btn_Bersih.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        ...
        Btn_Bersih.setBounds(390, 20, 120, 30);
        jPanel3.add(jSeparator1);
        jSeparator1.setBounds(50, 60, 630, 2);
        ...
        jScrollPane1.setBounds(90, 190, 570, 180);

        jLabel12.setFont(new java.awt.Font("Quixley LET", 0, 24)); // NOI18N
        jLabel12.setText("Cari Berdasarkan Kategori");
        jPanel3.add(jLabel12);
        jLabel12.setBounds(90, 80, 210, 30);

        CbCariKategori.setFont(new java.awt.Font("Quixley LET", 0, 18)); // NOI18N
        ...
        CbCariKategori.setBounds(350, 80, 310, 30);
        ...
        jButton2.setBounds(530, 120, 130, 30);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(210, 90, 680, 400);

        setSize(new java.awt.Dimension(907, 529));
